...
AND i.id_inmueble NOT IN (
    ...
    JOIN Contratos co ON cc.id_contrato = co.id_contrato
    JOIN Anuncios a2 ON a2.id_cliente = cc.id_vendedor
)
";
...
<head>
    <meta charset="UTF-8">
    <title>Nuestros Inmuebles</title>
...
<main class="container">
    ...
    <center><h2>Nuestros Inmuebles</h2></center>
    ...
    <section class="filters-section">
        <form method="POST" class="filtros">
            ...
            <div class="filter-group">
                <label>
                    Precio máximo:
                    <span id="precio_valor"><?= $precioMax ?: 500000 ?></span> €
                </label>
                <input type="range"
                       name="precio_max"
                       min="20000"
                       max="500000"
                       step="5000"
                       value="<?= $precioMax ?: 500000 ?>"
                       oninput="precio_valor.textContent=this.value">
            </div>

            <div class="filter-group">
                <label>
                    Superficie mínima:
                    <span id="m2_valor"><?= $m2Min ?: 20 ?></span> m²
                </label>
                <input type="range"
                       name="m2_min"
                       min="20"
                       ...
                       step="10"
                       value="<?= $m2Min ?: 20 ?>"
                       oninput="m2_valor.textContent=this.value">
            </div>
    ...
    <section class="inmuebles">
        ...
        <?php foreach ($inmuebles as $inmueble): ?>
            <div class="tarjeta-inmueble" data-id="<?= $inmueble['id_inmueble'] ?>">
                <img src="../img/<?= htmlspecialchars($inmueble['imagen']) ?>" alt="Imagen inmueble">
